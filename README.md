...
The docker on the first run will download the same version as tagged `All the Mods 10 To The Sky-1.0.2` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "All the Mods 10 To The Sky v1.0.2 Server Powered by Docker"
...
## Source (W3LFARe repo)
Github: https://github.com/EwanLyon/docker-allthemods10sky
